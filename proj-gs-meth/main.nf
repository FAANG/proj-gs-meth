...
if( params.aligner == 'bwameth' ){
    ...
    if( params.skip_deduplication || params.rrbs ) {
        ...
        process markDuplicates {
            ...
            file "${bam.baseName}.markDups.bam.bai" into ch_bam_index_for_methyldackel, ch_bam_index_cgmaptools //ToDo check if this correctly overrides the original channel
...
process multiqc {
    ...
    multiqc -f $rtitle $rfilename --config $multiqc_config . \\
        -m custom_content -m picard -m qualimap -m bismark -m samtools -m preseq -m cutadapt -m fastqc // -m methKit -m cgmaptools //
    """
}
